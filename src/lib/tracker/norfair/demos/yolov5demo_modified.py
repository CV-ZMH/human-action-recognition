...
parser.add_argument("--detector_path", type=str, help="YOLOv5 model path",
                    default='/home/zmh/hdd/Custom_Projects/object_tracking/MOT/Yolov5_DeepSort_Pytorch/yolov5/weights/yolov5m.pt')
parser.add_argument("--img_size", type=int, default="720", help="YOLOv5 inference size (pixels)")
parser.add_argument("--conf_thres", type=float, default="0.5", help="YOLOv5 object confidence threshold")
parser.add_argument("--iou_thresh", type=float, default="0.45", help="YOLOv5 IOU threshold for NMS")
parser.add_argument('--classes', type=int, help='Filter by class: --classes 0, or --classes 0 2 3',
                    default=0)
...
for input_path in files:
    ...
    for frame in video:
        ...
        norfair.draw_tracked_objects(frame, tracked_objects, id_thickness=3, radius=2)
